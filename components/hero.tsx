      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          >
            ...
            <span className="text-sm text-muted-foreground font-medium">Riyadh, Saudi Arabia | 2026</span>
          </div>

          {/* Main Heading - Using Bebas Neue style */}
          <h1
          ...
          >
            <span className="text-foreground">WE SHIFT</span>
            <br />
          ...
          >
            A full-service advertising agency partnering with ambitious brands to build 
            meaningful connections through creativity, strategy and measurable results.
          </p>
